...
import { FaEdit, FaUser, FaSignOutAlt, FaCheck, FaTimes, FaCamera, FaBuilding, FaBell, FaLock } from 'react-icons/fa';
import { useAuth } from '../../contexts/AuthContext';

interface ProfilePageFinalProps {
  darkMode: boolean;
...
const ProfilePageFinal: React.FC<ProfilePageFinalProps> = ({ darkMode, fontSize }) => {
  ...
  const handleSignOut = async () => {
    if (confirm('Czy na pewno chcesz się wylogować?')) {
      try {
        console.log('ProfilePageFinal: Attempting to sign out...');
        await signOut(); // This will handle everything including redirect
        console.log('ProfilePageFinal: Sign out initiated');
      } catch (error) {
        console.error('ProfilePageFinal: Error signing out:', error);
      }
    }
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className={`block font-medium mb-2 ${fontSizeClass}`}>Imię i nazwisko</label>
                    {editing ? (
                      <input
                        type="text"
                        value={fullName}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`px-2 py-1 rounded text-sm ${
                      ...
                      {mockProfile.is_company ? 'Firmowe' : 'Osobiste'}
                    </span>
                  </div>
